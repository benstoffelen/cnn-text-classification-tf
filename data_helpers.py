...
def clean_str(string):
    ...
    Commented out because this has taken place while gathering data
    """
...
def load_data_and_labels_from_csv(csvfile):
    positive = []
    negative = []
    neutral = []

    # Load data from files
    f = open(csvfile, 'r', encoding="utf8")  # opens file for reading
